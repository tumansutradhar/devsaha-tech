...
export function Estimator() {
  ...
  return (
    <section id="estimator" className="section-spacing relative overflow-hidden">
      ...
      <div className="site-container relative z-10">
        <div className="max-w-4xl mx-auto glass-card p-6 md:p-12">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-5xl font-bold mb-4 text-brand-text leading-tight">Project Scope Estimator</h2>
            <p className="text-lg text-brand-muted leading-relaxed">Select your requirements to get an instant baseline estimate for timeline and investment.</p>
          </div>
            ...
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <button
                  ...
                  className={`p-6 text-left border transition-all duration-300 ${selectedService === "api"
                ...
                >
                  <div className="flex justify-between items-start mb-4">
                    ...
                    {selectedService === "api" && <IoMdCheckmark className="text-brand-primary" size={20} />}
                  </div>
                ...
                <button
                  ...
                  className={`p-6 text-left border transition-all duration-300 ${selectedService === "fullstack"
                    ? "border-brand-secondary bg-brand-secondary/10 neon-glow-soft"
                ...
                >
                  <div className="flex justify-between items-start mb-4">
                    ...
                    {selectedService === "fullstack" && <IoMdCheckmark className="text-brand-secondary" size={20} />}
                  </div>
                ...
                <button
                  ...
                  className={`p-6 text-left border transition-all duration-300 ${selectedService === "audit"
                    ? "border-brand-glow bg-brand-glow/10 neon-glow-soft"
                    : "border-brand-border bg-brand-surface hover:border-brand-glow/40"
                    }`}
                >
                  <div className="flex justify-between items-start mb-4">
                    <h3 className="font-bold text-brand-text text-lg">System/DB Audit</h3>
                    {selectedService === "audit" && <IoMdCheckmark className="text-brand-glow" size={20} />}
                  </div>
              ...
              <div className="flex justify-end">
                ...
                >
                  Calculate Estimate <BiChevronRightCircle size={18} className="ml-2" />
                </Button>
              </div>
            </div>
          )}
          ...
          {step === 2 && (
            <div className="space-y-8 animate-in fade-in slide-in-from-right-8 duration-500">
              <div className="grid md:grid-cols-2 gap-8 bg-black/40 p-8 border border-brand-border/20">
                <div>
              ...
              <div className="bg-brand-surface p-6 border border-brand-primary/20">
