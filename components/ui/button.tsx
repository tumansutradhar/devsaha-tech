...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "primary", size = "default", asChild = false, ...props }, ref) => {
    ...
    const baseStyles = "inline-flex items-center justify-center whitespace-nowrap text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary focus-visible:ring-offset-2 focus-visible:ring-offset-brand-background disabled:pointer-events-none disabled:opacity-40 active:scale-[0.97]"
    ...
    const variants = {
      ...
      outline: "border border-white text-brand-text bg-transparent hover:text-black hover:bg-white",
